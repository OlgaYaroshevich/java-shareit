...
public class BookingRepositoryTest {
    ...
    public void findAllApprovedByItemIdAndUserIdTest() {
        ...
        assertThat(bookingRepository.findAllApprovedByItemIdAndUserId(item1.getId(), booker1.getId(), timestamp)).size().isEqualTo(1);
        assertThat(bookingRepository.findAllApprovedByItemIdAndUserId(item1.getId(), booker2.getId(), timestamp)).size().isEqualTo(0);
        ...
        assertThat(bookingRepository.findAllApprovedByItemIdAndUserId(item1.getId(), booker1.getId(), timestamp)).size().isEqualTo(2);
